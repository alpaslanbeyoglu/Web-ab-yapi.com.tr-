...
export const ComfortPackageOptions: React.FC = () => {
  // Real, benefit-focused comfort options offered to clients
  const options = [
    {
      icon: Zap,
      title: 'Tam Otomatik Devreye Giren Bina Jeneratörü',
      category: 'Kesintisiz Enerji',
      description: 'Elektrik kesintilerinde otomatik devreye girerek asansör, hidrofor su motorları, bina ortak alanları ve acil aydınlatmaları kesintisiz besleyen sessiz kabinli jeneratör sistemi.',
    },
    {
      icon: Layers,
      title: 'Çizilmez & Isıya Dayanıklı Porselen Mutfak Tezgahı',
      category: 'Mutfak Mimarisi',
      description: 'Yüksek sıcaklığa, lekelere ve çizilmelere karşı maksimum dirençli, gözeneksiz hijyenik yapısıyla mutfaklara uzun ömürlü zarafet katan 1. sınıf porselen tezgah.',
    },
    {
      icon: Flame,
    ...
    },
    {
      ...
      description: 'Salonda 4 mevsim ideal iklimlendirme sağlayan, düşük ses seviyeli ve minimum elektrik tüketen A++ inverter iklimlendirme ünitesi.',
    },
    {
      icon: Filter,
    ...
    {
      icon: Lock,
      title: 'Parmak İzli & Şifreli Akıllı Çelik Kapı Kilidi',
    ...
    <section className="bg-slate-900 text-white rounded-3xl p-6 md:p-10 shadow-2xl border border-slate-800 space-y-8 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto space-y-3">
        ...
        <h2 className="text-2xl md:text-4xl font-extrabold font-outfit tracking-tight text-white">
          Hak Sahiplerimize Özel Opsiyonel Konfor ve Donanım Çözümleri
        </h2>
        <p className="text-xs md:text-sm text-slate-300 leading-relaxed">
          Kentsel dönüşüm sürecinde standart inşaat teslimimize ek olarak, yeni evinde daha yüksek konfor ve kullanım kolaylığı isteyen müşterilerimize sunduğumuz opsiyonel paketler.
        </p>
      </div>
      ...
      <div className="relative z-10 bg-slate-950 p-4 md:p-5 rounded-2xl border border-amber-500/30 text-xs text-slate-300 space-y-3 shadow-lg">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-1">
            <strong className="text-white text-xs font-bold uppercase tracking-wide block">
              Paket & Sözleşme Bilgilendirmesi:
            </strong>
            <p className="leading-relaxed text-[11px] text-slate-300">
              Aşağıda yer alan konfor donanımları müşterilerimize <strong>opsiyonel Konfor Paketi</strong> kapsamında sunulmaktadır. Proje sözleşmesinde hak sahiplerinin talebi doğrultusunda daire veya bina bazında dahil edilebilir.
            </p>
          </div>
        </div>
        ...
        <div className="pt-3 border-t border-slate-800 flex items-center gap-3 text-amber-300 text-[11px] font-semibold">
          ...
          <span>
            <strong className="text-white">Ödeme Kolaylığı:</strong> Tercih edeceğiniz konfor paketi farklarında sözleşme kapsamında uygun taksit ve ödeme kolaylıkları sağlanmaktadır.
          </span>
        </div>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="pt-2 border-t border-slate-900 flex justify-between items-center text-[10px] text-amber-400/80 font-semibold">
                <span>Müşteri Opsiyonu</span>
                <span className="text-slate-400">AB Yapı Güvencesiyle</span>
              </div>
            </div>
          );
        })}
